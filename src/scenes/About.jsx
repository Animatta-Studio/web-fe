  ...
  return (
    <div className='mt-[100px] flex flex-col items-center'>
      ...
      <div className='flex sm:flex-row flex-col sm:p-10 p-5 justify-center space-x-20'>
        ...
        <motion.img initial={{x: '100vw'}} animate={{x: 0}} transition={{type:'spring', duration:1.2, bounce:0.25}} src={aboutus} className='sm:inline hidden w-1/3 p-2 bg-opacity-[0.5] z-[2]' />
      </div>
