    ...
    <div className="h-full flex flex-col mt-[100px] items-center">
      ...
      >
        <ul className="flex relative">
          <span
            className={`bg-[#0087E0] duration-500 ${courses[selected].dis} ${courses[selected].sd} msm:border-t-4 border-t-2 msm:border-l-4 border-l-2 msm:border-r-4 border-r-2 border-gray-900 msm:h-[95px] h-[75px] msm:w-[180px] w-[90px] absolute msm:-top-5 -top-6 msm:rounded-t-[30px] rounded-t-[25px] msm:z-0 z-[10]`}
          >
