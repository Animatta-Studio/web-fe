...
const LinkBar = () => {
  return (
    <nav className='fixed sm:flex hidden w-full text-white justify-center items-center text-center bg-[#db492f] z-[40] p-2'>
        <ul className='list-none sm:flex hidden justify-end items-center flex-1'>
          <li key='linkbar-1' className='font-poppins cursor-pointer text-[14px] text-white mr-10 font-bold rounded-lg' >
            <Link to='events' className="group text-white">
              News & Events
            </Link>
          </li>
