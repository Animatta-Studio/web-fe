...
const ContactLinkBar = () => {
  return (
    <motion.nav initial={{y:'-60vh',opacity:0}} animate={{y:0,opacity:1}} className='sm:flex hidden w-full text-white justify-center items-center text-center bg-[#64C0FF] z-[40] p-1'>
